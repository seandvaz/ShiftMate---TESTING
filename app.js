...
(() => {
  ...
  function openLeaveFormSheet(key,entry){
    ...
    summary.innerHTML=`<strong>${fmtFormDate(block.start)} – ${fmtFormDate(block.end)}</strong><small>${block.hours.toFixed(1)} paid leave hours from saved roster entries</small>`;
