...
(() => {
  ...
  const perthShiftLabels={PN:'Perth Assist Arvo',PA:'Perth Afternoon',PD:'Perth Assist Day',PM:'Perth Morning',PRD:'Perth Roaming Day',PRA:'Perth Roaming Arvo',UD:'Underground Day',UN:'Underground Arvo'};
